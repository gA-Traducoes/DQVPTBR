...
- Nome comum: "Dragon Quest - The Hand of the Heavenly Bride (Europe) (En,Fr,De,Es,It).nds"
- Código do jogo: "YV5P"
...
3. Em Patch file, selecione o arquivo "Dragon Quest V - Hand of the Heavenly Bride PT-BR.bps".
...
- O arquivo de saída é igual ao original: confirme se o arquivo BPS correto foi selecionado e se a ROM gerada foi salva com outro nome.
...
</p>Todo apoio ajuda na continuidade de novas traduções, revisões e melhorias.
